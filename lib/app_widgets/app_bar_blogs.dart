...
class CustomAppBarBlogs extends StatefulWidget {
  ...
  @override
  State<CustomAppBarBlogs> createState() => _CustomAppBarBlogsState();
  final double? height;
}

class _CustomAppBarBlogsState extends State<CustomAppBarBlogs> {
                    ...
                    children: [
                      widget.showBackButton == true
                        ...
                        padding: const EdgeInsets.only(left: 10,top: 10),
                            child: Align(
                              ...
                              onTap: () {
                                offersController.focusNodeForBlogs.unfocus();
                      ...
                      widget.showIcon == true
                          ? Padding(
                            ...
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: Image.asset(AppIcons.blogScreenAppbarIcon,
                              scale:4),
                            ),
                          )
                          : SizedBox.shrink(),
