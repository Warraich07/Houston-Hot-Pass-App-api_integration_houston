class FeaturedBlogsModel {
  ...
  FeaturedBlogsModel({
    ...
    required this.canRedeemOffer,
    required this.createdAt,
    required this.updatedAt,
  });

  factory FeaturedBlogsModel.fromJson(Map<String, dynamic> json) => FeaturedBlogsModel(
    id: json["id"],
    ...
    canRedeemOffer: json["can_redeem_offer"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "can_redeem_offer": canRedeemOffer,
