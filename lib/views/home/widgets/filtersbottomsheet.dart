...
class _FiltersBottomSheetState extends State<FiltersBottomSheet> {
  ...
  applyFilters() {
    ...
    // if (option != "Cuisine") {
      ...
      Get.to(() => FilterResults(filteredKeyWord: option,));
    _offersController.filteredOfferTypesList.clear();
    _offersController.filteredOffersCurrentPage.value=0;
    _offersController.filteredOffersLastPage.value=0;
    _offersController.filterOfferTypes(false,option);
    // }
  }
